  ...
  return (
    <div className=" jc-form__section-input relative font-sans">
      ...
      >
       ...
       jc-form__section-input--explain cursor-pointer
          `}
          >
            <svg
              width="16"
            ...
            <div
              className=" bg-[#302c42] text-[12px] font-[500] font-sans  rounded-[3px] text-white absolute top-[-50px] left-1/2 transform -translate-x-1/2 w-[200px] px-[12px] py-[8px] jc-bg-black
      ...
      <input
        ...
        id={name}
        name={name}
        class="bg-[#eff2f9] px-[16px] py-[12px] text-sm  font-sans rounded-[3px] focus:outline-none block w-full "
